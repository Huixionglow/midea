...
class Wmpickd1
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="IS_FULL_PACK", type="string", length=1, nullable=true, options={"default"="N","fixed"=true})
     */
    private $isFullPack = 'N';

    /**
     * @var string|null
     *
     * @ORM\Column(name="IS_FOC_STICKER", type="string", length=1, nullable=true, options={"default"="N","fixed"=true})
     */
    private $isFocSticker = 'N';

    /**
     * @var string|null
     *
     * @ORM\Column(name="CAL_VP_QTY", type="decimal", precision=20, scale=3, nullable=true)
     */
    private $calVpQty;
    ...
    public function getIsFullPack(): ?string
    {
        return $this->isFullPack;
    }

    public function setIsFullPack(?string $isFullPack): static
    {
    ...
    public function getIsFocSticker(): ?string
    {
        return $this->isFocSticker;
    }

    public function setIsFocSticker(?string $isFocSticker): static
    {
        $this->isFocSticker = $isFocSticker;

        return $this;
    }

    public function getCalVpQty(): ?string
    {
        return $this->calVpQty;
    }

    public function setCalVpQty(?string $calVpQty): static
    {
        $this->calVpQty = $calVpQty;
